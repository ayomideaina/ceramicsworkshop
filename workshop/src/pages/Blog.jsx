            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-6xl mx-auto">
              ...
              <div className="space-y-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
                  <div className="">
                    <img className="product-image my-5 md:mb-5 w-full h-50 sm:h-56 md:h-64 lg:h-80 object-cover rounded-lg shadow-sm"
                  ...
                  <div>
                    <h2 className= "text-lg mt-7 font-bold">What affects the quality of Ceramic products ?</h2>
