      ...
      <div 
        ...
        <div className="hero relative texts-center  text-White px-6 py-40 max-w-4xl mx-auto z-20">
          ...
          <p className="lg:text-xl  text-white">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec orci massa, dapibus quis
            molestie sit amet, pharetra vitae dolor. Praesent auctor, dui id maximus sagittis,
            lectus enim pharetra quam, ut laoreet tortor metus ut ipsum.
          </p>
          <Link to="/shop">
            <button className="btn px-12 py-3 text-lg mt-16 m-auto text-white  flex justify-center items-center">
              Show More
            </button>
          </Link>
        </div>
